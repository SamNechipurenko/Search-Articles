...
public class NewsClient implements Client{
    public static final String ARTICLE_BY_COUNTRY_URL = "http://newsapi.org/v2/top-headlines?country=";
    ...
    public News getAllCountryNews(String country){
        ...
        String articleLink = NewsClient.ARTICLE_BY_COUNTRY_URL + country + "&apiKey=" + NewsClient.API_KEY;
